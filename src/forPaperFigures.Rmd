...
```{r hac, echo = FALSE, warning = FALSE}
...
```{r, echo = FALSE}
woody.mds.simp.gg + ggtitle('a')
```

```{r, echo = FALSE}
ferns.mds.simp.gg +  ggtitle('b')
```
...
Plots of the ranges of (a) woody species and (b) ferns on Hirakimata _only_ and all three sites at an elevation of 150 m to 500 m (lower bnd, upper bnd) -> "lowland" species
