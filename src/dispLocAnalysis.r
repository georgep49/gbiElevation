...
woody.perm.pair <- pairwiseAdonis::pairwise.adonis2(mts.woody ~ site, data = woody.df, permutations = 9999)

ferns.df <- data.frame(site = site, mts.ferns)
ferns.perm.pair <- pairwiseAdonis::pairwise.adonis2(mts.ferns ~ site, data = ferns.df, permutations = 9999, )
